...
class User:
  ...
  async def server(self,ctx):
    ...
    embed.add_field(name="Server Invite Link",value="https://discord.gg/MjxqTwf")
    embed.add_field(name="Bot Invite",value="https://discordapp.com/api/oauth2/authorize?client_id=500154804954202124&permissions=-1&scope=bot")
    await ctx.send(embed=embed)
